 ...
 *
 * 自定义拦截器 参考 {@link com.github.pagehelper.PageInterceptor}
 * 1. 为了 Support PageSizeZero，由于pagesize传0时，不管此值为true或者是false都查询了所有数据
 *
        ...
        try {
            ...
            if (!dialect.skip(ms, parameter, rowBounds)) {
                ...
                if (dialect.beforeCount(ms, parameter, rowBounds)) {
                    ...
                    // Support PageSizeZero
                    if (localPage.getPageSize() == 0 && !localPage.getPageSizeZero()){
