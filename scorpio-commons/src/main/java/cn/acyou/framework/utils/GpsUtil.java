...
import cn.acyou.framework.utils.entity.LatLng;
...
public class GpsUtil {
    ...
    public static void main(String[] args) {
        ...
        GlobalCoordinates source = new GlobalCoordinates(39.923423, 116.368904);
        GlobalCoordinates target = new GlobalCoordinates(39.922501, 116.387271);
        double distanceMeter = getDistanceMeter(source, target);
