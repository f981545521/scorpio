...
import cn.acyou.framework.exception.AssertException;
...
public class Assert {
     ...
     * @param message the exception message to use if the assertion fails
     * @throws AssertException if the text is empty
     ...
     * @param message      the exception message to use if the assertion fails
     * @throws AssertException if the text contains the substring
     */
     ...
     * @param message the exception message to use if the assertion fails
     * @throws AssertException if the object array is {@code null} or contains no elements
     */
     ...
     * @param message    the exception message to use if the assertion fails
     * @throws AssertException if the collection is {@code null} or
     ...
     * @throws AssertException if the object is not an instance of type
     */
