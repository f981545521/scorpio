 ...
 *
 * <pre>   获取包下面有指定注解的类：
 *         List<Class<?>> classes = ClassUtil.getClasses("cn.acyou.scorpio.service");
 *         List<Class<?>> serviceClasses = ClassUtil.getAnnotationClass(classes, Service.class);
...
public class ClassUtil {
     ...
     */
    public static List<Class<?>> getAnnotationClass(List<Class<?>> classes, Class<? extends Annotation> clz) {
     ...
     * @return {@link List<Class>}
     */
    public static List<Class<?>> getAnnotationClass(String packageName, Class<? extends Annotation> clz) {
        return getAnnotationClass(getClasses(packageName), clz);
    }
}
