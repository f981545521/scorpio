...
public class NumberUtilCopy {
    ...
    public static String getCNNum(int srcNum) {
        ...
        if (srcNum <= 0) {
            ...
            while (srcNum > 0) {
                ...
                descnnum.insert(0, String.valueOf(CN_CHARS[singleDigit]));
                srcNum /= 10;
            }
        }
    ...
    public static void main(String[] args) {
        ...
        int t = 10;
        double j = 221.23;
        System.out.println(NumberUtilCopy.cvt(i, true));//四十点三
        System.out.println(NumberUtilCopy.cvt(t, true));//二千二百三十四
        System.out.println(NumberUtilCopy.cvt("" + j, true));//二百二十一点二三
