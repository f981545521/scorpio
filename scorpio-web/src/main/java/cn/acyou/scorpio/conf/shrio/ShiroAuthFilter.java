...
public class ShiroAuthFilter extends BasicHttpAuthenticationFilter {
    ...
    protected boolean isAccessAllowed(ServletRequest request, ServletResponse response, Object mappedValue) throws UnauthorizedException {
        ...
        String anonUrlStr = "/shiro/loginPage,/shiro/login,/task/**,/regist,/user/check/**,/swagger-ui.html,/swagger-resources/**,/v2/**,/webjars/**";
        String[] anonUrl = StringUtils.splitByWholeSeparatorPreserveAllTokens(anonUrlStr, ",");
