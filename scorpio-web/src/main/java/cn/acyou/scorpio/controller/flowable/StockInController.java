...
@Api(tags = "StockIn工作流测试")
@Controller
@RequestMapping(value = "stockIn")
public class StockInController {
    private static final String process_Name = "StockInProcess";
    @Autowired
     ...
     * 获取组的待办列表
     */
    @GetMapping(value = "/listByGroupName")
    @ResponseBody
    public Result listByGroup(String groupName) {
        List<Map<String, String>> resultList = Lists.newArrayList();
