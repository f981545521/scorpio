...
public class FastDfsTest1 {
    ...
    public void testUpload() throws Exception {
        ...
        try {
            ...
            String fileIds = storageClient.upload_file1(group_name, local_filename, file_ext_name, pairs);
    ...
    public void testDelete() throws Exception { //删除文件
        ...
        try {
            String groupName = "group1";
            String filePath = "group1/M00/00/00/wKgBRV8hKkaAVNATAA0Fgpto1-A123.jpg";
            ClientGlobal.initByProperties(FASTDFS_CLIENT_PROPERTIES);

            TrackerClient tracker = new TrackerClient();
            trackerServer = tracker.getConnection();

            StorageClient1 storageClient = new StorageClient1(trackerServer, tracker.getStoreStorage(trackerServer));
